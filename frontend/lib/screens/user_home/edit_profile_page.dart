...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  void initState() {
    ...
    _profilePictureController =
        TextEditingController(text: widget.user.profilePictureUrl ?? '');
  ...
  void _saveProfile() {
    if (_formKey.currentState!.validate()) {
      final updatedUser = widget.user.copyWith(
        ...
        profilePictureUrl: _profilePictureController.text.isEmpty
            ? null
  ...
  Widget _buildTextField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        // Use null so Flutter picks the card/surface color automatically
      ),
    );
  }
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            const Text('In production, you would use image picker.',
